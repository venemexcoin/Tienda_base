                ...
                <li class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ">
                    <div class="product product-style-3 equal-elem ">
                        <div class="product-thumnail">
                            <a href="{{route('product.details',['slug'=>$item->model->slug])}}" title="{{$item->model->regular_price}}">
                                <figure><img src="{{asset('assets/images/products')}}/{{$item->model->image}}" class="imageShow"  alt="{{$item->model->regular_price}}"></figure>
                            </a>
                        </div>
