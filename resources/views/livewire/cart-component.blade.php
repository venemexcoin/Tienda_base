    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            ...
            <div class="wrap-iten-in-cart">
                ...
                @endif 
                @if(Session::has('success_message_r'))
                <div class="alert alert-danger">
                    <strong>Success</strong>{{Session::get('success_message_r')}}
                </div>
            @endif      
                @if(Cart::instance('cart')->count() > 0)
                ...
                <div class="checkout-info">
                    ...
                    <div class="summary-item">
                        <form wire:submit.prevent="applyCouponCode">
                            ...
                            <button type="submit" class="btn btn-smoll">Apply</button>
                        </form>
                    </div>
                    @endif 
                    @endif
            ...
            @endif      
                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="price-field produtc-price"><p class="price">${{$item->model->regular_price}}</p>
                        </div>
                        <div class="quantity">
