            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" wire:submit.prevent="saveSettings">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">VK</label>
                            <div class="col-md-4">
                                <input type="text" placeholder="VK" class="form-control input-md" wire:model="vk">
                                @error('vk') <p class="text-danger">{{$message}}</p> @enderror
                            </div>
                        </div>
